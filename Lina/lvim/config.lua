...
lvim.builtin.which_key.mappings["cm"] = {
    name = "+CMake",
    b = { ":!cmake --build ./build -j16 <cr>", "Build" },
    g = { ":!mkdir build && cmake -S . -B ./build -DEXPORT_COMPILE_COMMANDS=1 && ln -fs ./builld/compile_commands.json ./compile_commands.json <cr>", "Generate" },
    r = { ":!rm -rfv ./build && rm ./compile_commands.json <cr>", "Remove" },
}
